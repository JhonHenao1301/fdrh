  ...
  return (
    <table className="w-full border border-collapse rounded-md border-slate-400 max-h-64 flex flex-col gap-4 overflow-auto px-4 py-2 text-xs text-justify">
      ...
      <ul>
        ...
        <li>
          Individuals employed and administered by the Alliance but hosted by
          another institution (CGIAR entities, organizations, universities,
          programs, or agencies), unless otherwise agreed among the parties.
        </li>
        <li>
          Individuals employed by the Alliance but administered and hosted by
          another institution (CGIAR entities, organizations, universities,
          programs, or agencies), unless otherwise agreed among the parties.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          organizations, universities, programs, or agencies) but administered
          and hosted by the Alliance, unless otherwise agreed by the parties.
        </li>
        <li>
          Individuals recruited, employed, and administered by another
          institution (CGIAR entities, organizations, universities, programs, or
          agencies) but hosted by the Alliance, unless otherwise agreed by the
          parties.
        </li>
        <li>
          Associated members of staff, visiting researchers, interns,
          complementary staff, or consultants.
        </li>
        <li>
          Individuals recruited, employed, and administered by the Alliance on
          behalf of other institutions (CGIAR entities, organizations,
          universities, programs, or agencies) but hosted by the Alliance,
          unless otherwise agreed by the parties.
        </li>
      </ul>
      <ol start={4}>
        <li>
          <strong>Overarching principles</strong>
        </li>
      </ol>
      <ul>
        <li>
          <strong>Organization and employee driven:</strong>Education Support
          decisions will be made considering the development of the employee and
          the areas of work, objectives, and strategic direction of the
          Alliance.
        </li>
        <li>
          <strong>Transparency:</strong>Education Support decisions will be
          fully transparent to staff to the extent possible.
        </li>
        <li>
          <strong>Gender, diversity and inclusion:</strong>We strongly believe
          in diversity as a key element toward effectiveness, capacity building,
          intellectual strength, and significant contributions in the context of
          an international research organization. Education Support
          opportunities will be provided without regard to race, ethnicity,
          gender, age, sexual orientation, marital status, religion,
          citizenship, and physical or mental disabilities.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Have received an 'effective' or “highly effective” performance rating
          in the last year.
        </li>
      ...
      <ul>
        <li>
          ...
          courses. Study leave can be requested in conjunction with financial
          support or as a request pertaining to a self-funded higher education
          initiative.
        </li>
        <li>
          Study leave must be discussed in advance with the manager and included
          in the Education Support Request Form. Study leave will be considered
          in the context of organizational objectives, staff workload, and
          financial resources available.
        </li>
        <li>
          Study leave will not exceed 10 working days per year. Any additional
          leave required can be requested through other available leave of
